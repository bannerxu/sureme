...
public class StringUtils {
    ...
    public static boolean isMobile(String mobiles) {
        Pattern p = compile("^1[3|4|7|5|8][0-9]{9}$");
    ...
    public static boolean isCard(String cardId) {
        ...
        //身份证正则表达式(15位)
        Pattern isIDCard1 = compile("^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$");
        //身份证正则表达式(18位)
        Pattern isIDCard2 = compile("^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9]|X)$");
    ...
    public static boolean checkUsername(String username) {
        Pattern p = compile("^(?![0-9]+$)[0-9A-Za-z_\u0391-\uFFE5]{2,15}$");
     ...
     * @param type         ：单号类型
     * @param numb         ：当前数
     * @param endNum:随机两位数 协议编号：如：HT+20130927（时间）+0013(当前订单的顺序)+09（随机数）
